    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('DR', 'Doctor'), ('NU', 'Nurse'), ('SP', 'Specialist'), ('PA', 'Patient'), ('LAB', 'LaboratorIST'), ('RT', 'Receptionist'), ('AD', 'Admin'), ('DI', 'Director'), ('PH', 'Pharmacist')], max_length=50, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Admin More',
                'verbose_name_plural': "Admin's More",
            },
        ),
        migrations.CreateModel(
            name='DirectorMore',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('User', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('halu', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'verbose_name': 'Specialist More',
                'verbose_name_plural': "Specialist's More",
            },
        ),
        migrations.CreateModel(
            name='Admin',
